pessoas = [
  { pessoa1: { nome: 'joão', email: 'joao@gmail.com' } },
  { pessoa2: { nome: 'Breno', email: 'breno@hotmail.com', funcionaria: 'Back-end' } },
  { pessoa3: { nome: 'Souza', email: 'souza@outlook.com' } },
  { pessoa4: { nome: 'Melo', email: 'melo@gmail.com', funcionaria: 'Front-end' } },
  { pessoa5: { nome: 'João Breno', email: 'joaobreno@gmail.com' } },
  { pessoa6: { nome: 'Breno Souza', email: 'brenosoua@hotmail.com', funcionaria: 'Full-stack' } },
